...
public class ServerOptions extends javax.swing.JFrame {
    ...
    private ServerOptions() {
        ...
        HashMap<String, ArrayList> params = plugins.getInitializeParams();
        HashMap<String, String> PluginAndNameClasses = new HashMap<String, String>();
        ...
        PluginPanelLoader pcl;

        pcl = PluginPanelLoader.getInstance(Thread.currentThread().getContextClassLoader());
        name = pcl.defineClass(pp);
        File f = new File("pluginClasses/" + name.getName().substring(name.getName().lastIndexOf(".") + 1) + ".class");
        f.createNewFile();
        FileOutputStream fos = new FileOutputStream(f);
        fos.write(pp);
        fos.close();

        PluginAndNameClasses.put(key, name.getName());
        ArrayList p = params.get(key);
        if (p == null)
        {
        return;
        }
        ...
        //cons[0].newInstance();
        //PluginPanel panel = (PluginPanel) cons[0].newInstance();
        panel.initialize(p);
        this.panels.put(key, panel);
        //this.jTabbedPane1.addTab(key, (Component) panel);


        }

        keys = PluginAndNameClasses.keySet();
        Collection<PluginPanel> c = PanelPluginsController.getInstance().getPanels();
        this.panels = new HashMap<String, PluginPanel>();
        for (String key : keys)
        {
        String ClassName = PluginAndNameClasses.get(key);
        PluginPanel tmp = null;
        for (PluginPanel panel : c)
        {
        if (panel.getClass().getName().compareTo(ClassName) == 0)
        {
        tmp = panel;
        }
        }
        if (tmp != null)
        {
        this.panels.put(key, tmp);
        }
        }
        keys = this.panels.keySet();
        for (String key : keys)
        {
        this.panels.get(key).initialize(params.get(key));
        this.jTabbedPane1.addTab(key, (Component) this.panels.get(key));
        }
        } catch (IOException ex)
        {
        Logger.getLogger(ServerOptions.class.getName()).log(Level.SEVERE, null, ex);
        ...
        //this.jTabbedPane1.addTab(null, rootPane);
    ...
    private void loadQueryRetrieve() {
        try {
            ...
            Hashtable<String, String> table = queryRetrieve.getFindModalities();
            Enumeration en = table.elements();

            while (en.hasMoreElements()) {
                jComboBoxModalityFind.addItem(en.nextElement());
            }
    ...
    private void loadTagsDIMFields(DefaultMutableTreeNode top) {
        try {
            ...
            Hashtable<String, ArrayList<TagValue>> groupTable = indexOptions.getDIMFields();
    ...
    private void loadTagsOthers(DefaultMutableTreeNode top) {
        try {
            ...
            Hashtable<String, ArrayList<TagValue>> groupTable = indexOptions.getManualFields();
    ...
    private void initComponents() {
        ...
        jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
        ...
        jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
        ...
        jLabel30.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
        ...
        jButtonTagsManual.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/tags_manual.jpg"))); // NOI18N
        ...
        jButtonTagsDIM.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/icon_patient.jpg"))); // NOI18N
        ...
        jButtonTagsModalities.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/search_icon.jpg"))); // NOI18N
        ...
        jButtonTagsModalityAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/add.png"))); // NOI18N
        ...
        jButtonTagsModalityRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/remove.png"))); // NOI18N
        ...
        jButtonTagsAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/add.png"))); // NOI18N
        ...
        jButtonTagsRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/remove.png"))); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButtonTagsAdd, javax.swing.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        jButtonTagsRemoveDic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/remove.png"))); // NOI18N
        ...
        jButtonTagsAddDic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/add.png"))); // NOI18N
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addGap(174, 174, 174)
                        .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButtonTagsRemoveDic, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel11Layout.createSequentialGroup()
        ...
        jLabel27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/data-server.png"))); // NOI18N
        ...
        jLabel57.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pt/ua/dicoogle/gfx/aboutico.gif"))); // NOI18N
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jSeparator8, javax.swing.GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
                            .addComponent(jSeparator4, javax.swing.GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
                            .addComponent(jSeparator7, javax.swing.GroupLayout.DEFAULT_SIZE, 722, Short.MAX_VALUE)
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
