...
public class IndexedMetaData extends javax.swing.JFrame
{
    ...
    public IndexedMetaData(SearchResult searchResult, MainWindow main)
    {
        ...
        String PatientName = (String) searchResult.getExtrafields().get("PatientName");

        this.setTitle(PatientName + " - " + searchResult.getFileName());
        fill();
    ...
    {
        jLabelTitle.setText(searchResult.getFileName());
    }
    ...
    class MetaDataModel extends AbstractTableModel
    {
        ...
        {            
            try {
                Hashtable resultFields = searchResult.getExtrafields();
