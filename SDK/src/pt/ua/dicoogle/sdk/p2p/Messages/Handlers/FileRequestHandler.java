...
//import pt.ua.dicoogleSDK.p2p.jgroups.sockets.MulticastSocketHandler;
    ...
    public void update(Observable o, Object arg)
    {
        ...
        if (TaskRequest.class.isInstance(o))
        {
                    ...
                    && List.class.isInstance(results.get(TaskRequestsConstants.R_SEARCH_RESULTS)))
            {
                ...
                NPA.sendFile(sr.getOrigin(), (String) parameters.get(TaskRequestsConstants.P_REQUESTER_ADDRESS));
